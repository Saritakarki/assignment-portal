...
<body  style="background-color: #84b29b">
	...
	<div >
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" id='login-form' name='login-form' action="teacherLogin.jsp">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="${pageContext.request.contextPath}/login/teacherSign-up.jsp">
							Create your Account
